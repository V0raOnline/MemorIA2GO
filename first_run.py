...
def asegurar_acceso_directo() -> str:
    ...
    ps = (
        ...
        "$s.Description = 'M3M0R.IA - your memory, on your disk'; "
...
def main() -> int:
    ...
    for nombre in preparar_mapas():
        print(f"Created {nombre} from its template.")
    ...
    if asegurar_acceso_directo() == "creado":
        print("Shortcut M3M0R-IA.lnk created; you can pin it or copy it to your desktop.")
